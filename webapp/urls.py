...
from webapp.views import task_list_view, task_create_view, task_update_view, task_delete_view, task_detail_view
...
urlpatterns = [
    ...
    path('edit/<int:pk>/update/', task_update_view, name='task_update'),
